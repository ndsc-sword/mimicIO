...
package org.ndsc.mnos.dicovery;
...
import org.ndsc.mnos.elements.network.PhysicalNetwork;
import org.ndsc.mnos.elements.port.PhysicalPort;
import org.ndsc.mnos.io.OVXSendMsg;
import org.ndsc.mnos.packet.Ethernet;
import org.ndsc.mnos.packet.OVXLLDP;
...
public class SwitchDiscoveryManager implements LLDPEventHandler, OVXSendMsg,
    ...
    private final OVXMessageFactory ovxMessageFactory = OVXMessageFactory
            .getInstance();
    private Logger log = LoggerFactory.getLogger(SwitchDiscoveryManager.class);
