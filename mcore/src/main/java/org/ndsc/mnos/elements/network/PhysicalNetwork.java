package org.ndsc.mnos.elements.network;

import org.jboss.netty.util.HashedWheelTimer;
import org.ndsc.mnos.elements.datapath.PhysicalSwitch;
import org.ndsc.mnos.elements.link.PhysicalLink;
import org.ndsc.mnos.elements.port.PhysicalPort;
...
public class PhysicalNetwork extends Network<PhysicalSwitch, PhysicalPort, PhysicalLink> {
    ...
    private static Logger logger = LoggerFactory.getLogger(PhysicalNetwork.class);

    private PhysicalNetwork() {
        PhysicalNetwork.logger.info("Starting network discovery...");
    ...
    public static void reset() {
        logger.debug("PhysicalNetwork has been explicitly reset. "
