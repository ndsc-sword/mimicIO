...
import org.ndsc.mimicIO.packet.OVXLLDP;
...
public class SwitchChannelHandler extends OFChannelHandler {
    ...
    public SwitchChannelHandler(final MNOSManager manager) {
    ...
    public void exceptionCaught(final ChannelHandlerContext ctx,
        ...
        if (e.getCause() instanceof ReadTimeoutException) {
            // switch timeout
            this.logger.error("Disconnecting switch {} due to read timeout ",
            ...
            this.logger.error("Disconnecting switch {} due to IO Error.",
                           this.getSwitchInfoString());

            ctx.getChannel().close();
        } else if (e.getCause() instanceof SwitchStateException) {
            this.logger.error("Disconnecting switch {} due to switch state error",
                           this.getSwitchInfoString());
            ...
            this.logger.error("Could not process message: queue full",
                           e.getCause());
