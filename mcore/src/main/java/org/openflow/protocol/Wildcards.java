...
public class Wildcards {
    ...
    public static Wildcards of(final Flag setFlag) {
    ...
    public static Wildcards of(final Flag... setFlags) {
        int flags = 0;
        for (final Flag flag : setFlags) {
    ...
    public static Wildcards ofMatches(final Flag setFlag) {
     ...
     */
    public static Wildcards ofMatches(final Flag... setFlags) {
     ...
     * unmodified. </b>
     */
    public Wildcards wildcard(final Flag flag) {
     ...
     * unmodified. </b>
     */
    public Wildcards wildcard(final Flag... setFlags) {
     ...
     * unmodified. </b>
     */
    public Wildcards matchOn(final Flag flag) {
     ...
     * unmodified. </b>
     */
    public Wildcards matchOn(final Flag... setFlags) {
        int flags = this.flags;
        for (final Flag flag : setFlags) {
            flags = flag.matchOn(flags);
        }
     ...
     */
    public EnumSet<Flag> getWildcardedFlags() {
        final EnumSet<Flag> res = EnumSet
                .noneOf(Flag.class);
